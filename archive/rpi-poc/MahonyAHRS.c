/**
 * clone from https://github.com/PaulStoffregen/MahonyAHRS/blob/master/src/MahonyAHRS.cpp
 * migrated to C
 */
//=============================================================================================
// MahonyAHRS.c
...
char anglesComputed = 1.0f / DEFAULT_SAMPLE_FREQ;
